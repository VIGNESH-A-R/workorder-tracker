...
import { createWorkOrder, getCustomers, getTechnicians } from "../api.js";
    ...
    <div className="fixed inset-0 z-30 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-xl flex flex-col animate-slide-in">
        <div className="flex items-center justify-between px-6 h-16 border-b border-border shrink-0">
          ...
          <button
            onClick={onClose}
            className="h-8 w-8 rounded-control flex items-center justify-center text-ink-muted hover:bg-slate-100 transition-colors"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          ...
          <div className="border-t border-border px-6 py-4 flex items-center justify-end gap-3 shrink-0">
            <button
              type="button"
              onClick={onClose}
              className="rounded-control px-4 py-2 text-sm font-medium text-ink-muted hover:bg-slate-100 transition-colors"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="rounded-control bg-primary hover:bg-primary-hover disabled:opacity-60 text-white text-sm font-medium px-4 py-2 transition-colors"
            >
