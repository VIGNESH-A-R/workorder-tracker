...
function NotConnectedState({ providerLabel }) {
  return (
    <div className="bg-white border border-border rounded-card shadow-card py-16 text-center">
      ...
      <p className="text-sm font-medium text-ink">{providerLabel} isn&rsquo;t connected yet</p>
      <p className="text-sm text-ink-muted mt-1 mb-4">
        Connect your {providerLabel} account to see issues here.
      </p>
      <Link
        to="/settings"
...
function ResultsList({ loading, error, providerLabel, issues }) {
  if (error) {
    return (
  ...
  if (loading) {
    return (
      <div className="bg-white border border-border rounded-card shadow-card flex flex-col items-center justify-center py-16">
        ...
        <p className="text-sm text-ink-muted">Loading issues from {providerLabel}...</p>
      </div>
    );
  }
...
function JiraIssues() {
  ...
  if (notConnected) {
    return <NotConnectedState providerLabel="Jira" />;
  }
  ...
  return (
    <>
      ...
      <ResultsList loading={loading} error={error} providerLabel="Jira" issues={visibleIssues} />
...
function GitHubIssues() {
  ...
  if (notConnected) {
    return <NotConnectedState providerLabel="GitHub" />;
  }
  ...
  return (
    <>
      ...
      <ResultsList loading={loading} error={error} providerLabel="GitHub" issues={issues} />
    </>
  );
}
