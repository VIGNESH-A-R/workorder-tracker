            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <h1 className="text-lg font-semibold text-ink">
                  {workOrder.title || <span className="text-slate-400 italic font-normal">Untitled</span>}
                </h1>
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="text-sm border border-border rounded-control px-2.5 py-1.5 bg-white text-ink focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:opacity-50"
                >
                  {STATUSES.map((status) => (
